              ...
              <v-table fixed-header class="shadow-sm rounded-lg">
                <thead>
                  <tr>
                    ...
                    <th class="text-left hidden sm:table-cell">Sample Image</th>
                  ...
                  <tr v-for="(gallery, index) in galleries" :key="gallery.id">
                    ...
                    <td>
                      <img 
                        ...
                        alt="Gallery Image" 
                        class="carousell-image p-2 hidden sm:table-cell"
                      >
                    </td>
                    <td class="text-center">
                        <div class="flex justify-center items-center gap-1">
                            <button @click="viewGallery(gallery.id)" class="p-2 rounded-full group transition-all duration-500 flex item-center" title="Pre-View">
                            ...
                            <button @click="deletePost(gallery.id)" class="p-2 rounded-full  group transition-all duration-500  flex item-center" title="Delete">
