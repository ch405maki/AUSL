<template>
    ...
    <AuthenticatedLayout>
      ...
      <template #action>
          <div class="flex justify-start font-semibold text-xl flex-grow p-5 text-gray-800">
            Pubmat Creation Page
          </div>
        </template>
              ...
              <div class="w-full md:w-1/3 p-3 flex justify-start bg-white rounded-lg mt-1">
                <form @submit.prevent="createBanner" class="w-full">
                  <div class="text-left mb-4">
                    <h2 class="text-xl font-semibold text-gray-800">Pubmat Content</h2>
                  </div>
                  ...
                  <div class="col-span-12 mt-4">
                    <InputLabel for="footnote" value="Foot Note" />
                    <ckeditor :editor="editor" v-model="form.footnote" :config="editorConfig"></ckeditor>
                  </div>
