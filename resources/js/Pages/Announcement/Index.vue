                  ...
                  <tr v-for="(post, index) in filteredPosts" :key="post.id">
                    ...
                    <td>
                      <div class="flex justify-center">
                        <!-- update btn -->
                        <button @click="() => showPost(post.id)" class="p-2 rounded-full group transition-all duration-500 flex item-center" title="Preview">
                        ...
                        <button @click="edit(post.id)"  class="p-2  rounded-full  group transition-all duration-500  flex item-center">
                        ...
                        <button @click="openChangeStateModal(post.title, post.id)" class="p-2 rounded-full group transition-all duration-500 flex items-center" title="Archive">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path class="stroke-gray" d="M21 7H3V5C3 4.44772 3.44772 4 4 4H20C20.5523 4 21 4.44772 21 5V7ZM3 8V19C3 19.5523 3.44772 20 4 20H20C20.5523 20 21 19.5523 21 19V8H3ZM9 13H15V15H9V13Z" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                    </div>
                    </td> 
