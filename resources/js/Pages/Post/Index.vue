                  ...
                  <tr v-for="(post, index) in posts" :key="post.id">
                    ...
                    <td>
                      <div class="flex items-center gap-1">
                        ...
                        <button @click="deletePost(post.id, post.title)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
                        ...
                        <button @click="openChangeStateModal(post.title)" class="p-2 rounded-full group transition-all duration-500 flex items-center">
...
const openChangeStateModal = (title) => {
...
const changeState = (id) => {
  Inertia.patch(route('posts.updateState', id), { state: 1 }, {
    onSuccess: () => {
