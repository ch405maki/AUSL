<template>
    ...
    <div class="mt-6">
        ...
        <h1 class="text-slate-800 text-left mb-4 font-bold text-lg md:text-xl lg:text-2xl">Stay connected with AUSL</h1>
        <p class="text-center font-normal text-slate-700 text-md md:text-lg lg:text-xl mb-8">
