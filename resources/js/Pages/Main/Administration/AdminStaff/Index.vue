            ...
            <div class="max-w-7xl mx-auto px-4 py-4 lg:py-8">
              <div class="flex flex-col md:flex-row justify-between gap-8">
                ...
                <div class="mb-8 sm:mt-4 md:mt-8 lg:mt-10 xl:mt-12 text-sm sm:text-lg">
                    <div class="ml-4">
                        <h2 class="mb-4 leading-6 font-medium text-official-purple-900 capitalize">On this page</h2>
                        <hr class="mb-4 border-1 border-official-purple-800">
                        <h3 class="font-normal text-gray-800 mb-8">Administration Officers</h3>
                    </div>
                    <div class="ml-4">
                        <h2 class="text-official-purple-900 font-medium mb-4">Related Links</h2>
                        <hr class="mb-4 border-1 border-official-purple-800">
