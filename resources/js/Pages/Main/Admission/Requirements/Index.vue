        ...
        <div class="flex flex-col md:flex-row justify-between gap-8">
                ...
                <div class="mb-8">
                  ...
                  <div class="pb-4 mt-2 text-secondary-500 text-lg font-normal text-gray-800">
                    <p>
                      ...
                      <br>
                      <div class="bg-official-purple-200 px-6 py-4 mx-2 mt-6 rounded-md text-lg flex items-center mx-auto border">
          ...
          <div class="mb-8 sm:mt-4 md:mt-8 lg:mt-10 xl:mt-12">
              ...
              <hr class="mb-4 border-1 border-official-purple-800">
                  <h3 class="text-lg font-normal text-gray-800 mb-8">Requirements</h3>
              </div>
              <div class="ml-4">
