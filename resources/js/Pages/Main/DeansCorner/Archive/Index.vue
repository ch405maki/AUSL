<template>
        ...
        <div class="container mx-auto px-4 py-4 lg:py-8">
            ...
            <div class="flex flex-col md:flex-row justify-center mb-10">
              ...
              <div class="w-full md:w-2/3 p-4 order-2 md:order-2 text-slate-600 reveal-text">
                <div class="pr-4">
                  ...
                  <a @click.prevent="toggleShowMore" class="text-official-purple-900 font-normal mb-4 border-[1px] border-official-purple-800 hover:bg-official-purple-800 hover:text-white rounded-xl px-4 py-2 transition-colors duration-300 cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row justify-center mb-4">
              ...
              <div class="w-full md:w-2/3 p-4 order-2 md:order-1 text-slate-600 reveal-text">
                ...
                <a @click.prevent="toggleShowMoresecond" class="text-official-purple-900 font-normal mb-4 border-[1px] border-official-purple-800 hover:bg-official-purple-800 hover:text-white rounded-xl px-4 py-2 transition-colors duration-300 cursor-pointer">
  ...
  const ShowMoresecond = ref(false);
  ...
  function toggleShowMoresecond() {
    ShowMoresecond.value = !ShowMoresecond.value;
  }
