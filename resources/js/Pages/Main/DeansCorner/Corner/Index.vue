          ...
          <div class="flex flex-col md:flex-row justify-between gap-8">
              ...
              <div class="ml-2">
                ...
                <div class="w-full">
                    ...
                    <div class="text-left flex items-justify mb-4">
                        <div class="mr-0">
                        <img :src="dean.image" alt="Image Logo" class="min-w-32 w-32 h-min max-h-100 mr-2">
                        </div>
                        <div class="text-justify ml-2">
                        <h3 class="text-purple-800 font-semibold text-md tracking-wide leading-6">
                            <a :href="`/announcement/show/${dean.id}`" class="text-lg font-medium text-purple-900 hover:underline">{{ dean.title }}</a>
                        </h3>
                        ...
                        <a :href="`/announcement/show/${dean.id}`" class="text-lg font-normal text-gray-700 mb-4 hover:text-official-purple-600 hover:underline">Read more</a>
                        </div>
                    </div>
            ...
            <div class="mb-8 sm:mt-4 md:mt-8 lg:mt-10 xl:mt-12">
                ...
                <ul class="list-inside list-disc">
                    <li class="text-lg font-normal text-official-purple-800 hover:underline"><a href="">Latest News</a></li>
                    <li class="text-lg font-normal text-official-purple-800 hover:underline"><a href="">Latest Announcement</a></li>
                    <li class="text-lg font-normal text-official-purple-800 hover:underline"><a href="">Latest Events</a></li>
                </ul>
                </div>
            </div>
            </aside>
