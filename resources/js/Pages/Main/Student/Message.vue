<template>
    <section class="relative bg-purple-200 bg-blend-multiply">
      ...
      <div class="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 sm:py-6 lg:py-8 reveal-text">
        <h1 class="mb-4 pt-4 text-2xl font-extrabold tracking-tight leading-none text-slate-700 md:text-2xl lg:text-4xl dark:text-white">
          Welcome to Arellano Law Community
        </h1>
        <p class="mb-8 text-left text-lg font-medium text-slate-800 lg:text-xl">
    ...
    <div class="container mx-auto px-4 py-4 lg:py-8">
      <!-- First Section -->
      <div class="flex flex-col md:flex-row justify-center bg-white shadow-lg rounded-lg p-1 reveal-text">
        ...
        <div class="w-full md:w-2/3 p-4 order-2 md:order-2 text-slate-700">
          <p class="text-justify mb-4 font-extrabold text-2xl">Welcome to the Arellano University School of Law website!</p>
