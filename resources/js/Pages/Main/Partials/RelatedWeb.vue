<template>
    ...
    <div class="flex flex-wrap justify-center items-start space-x-8 my-8">
        ...
        <div class="flex flex-col items-center w-24">
        <a href="https://arellanolaw.org/" class="text-center">
            <img class="w-full transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0 transform hover:scale-105" src="/images/alflogo.png" alt="Logo">
            <span class="mt-2 block w-full text-center text-slate-700">Arellano Law Foundation</span>
        </a>
        </div>
    </div>
