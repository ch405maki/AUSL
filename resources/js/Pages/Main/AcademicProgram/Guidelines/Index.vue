        ...
        <div class="flex flex-col md:flex-row justify-between gap-8">
          ...
          <section class="w-full md:w-3/4 relative">
            ...
            <div class="ml-2">
              ...
              <div v-for="(guideline, index) in guidelines" :key="index">
                <div class="mb-8">
                    <h1 class="text-official-purple-900 font-bold mb-4 text-xl sm:text-2xl text-pretty">{{guideline.title}}</h1>
          ...
          <div class="mb-8 sm:mt-4 md:mt-8 lg:mt-10 xl:mt-12">
              ...
              <hr class="mb-4 border-1 border-official-purple-800">
                  <h3 class="text-lg font-normal text-gray-800 mb-8">Academic Guidelines</h3>
              </div>
              <div class="ml-4">
