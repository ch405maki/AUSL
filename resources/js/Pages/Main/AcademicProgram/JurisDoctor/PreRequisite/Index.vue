<template>
  ...
  const subjects = ref([
  {
    subjects: [
      ...
      { title: 'Civil Law Review and Integration', preRequisite: 'Multiple Laws' },
      { title: 'Civil Procedure II', preRequisite: 'Civil Procedure I' },
      { title: 'Commercial Law Review and Integration', preRequisite: 'Multiple Laws' },
      ...
      { title: 'Political and International Law Review and Integration', preRequisite: 'Multiple Laws' },
      { title: 'Private International Law', preRequisite: 'Multiple Laws' },
      { title: 'Public International Law', preRequisite: 'Constitutional Law I' },
      { title: 'Remedial Law Review and Integration', preRequisite: 'Multiple Laws' },
