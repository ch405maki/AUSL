        ...
        <div class="flex flex-col min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <v-tabs-window-item value="option-1">
                                ...
                                <v-card-text>
                                    ...
                                    <div class="header-container p-6 rounded-sm mb-6 border-l-4 border-purple-900 bg-purple-50">
                                        <div class="text-left">
                                        <h1 class="text-2xl font-bold text-purple-900 mb-4">Welcome to the Dean's Section</h1>
                                        <p class="text-lg text-slate-800 mb-6">Discover various aspects of Dean's and stay up-to-date with our latest announcements.</p>
                                        </div>
                                    </div>
                                    <!-- End of Header Section initialOpen-->
                                    
                                    <AccordionItem title="Maximum number of units for Graduating Students">
                ...
                <div class="w-full md:w-1/5 p-2 flex justify-start mt-4">
                    <div class="text-left">
                    <div class="mb-2">
                        <h2 class="mb-2 text-md leading-6 font-bold text-purple-900 capitalize">Dean's</h2>
