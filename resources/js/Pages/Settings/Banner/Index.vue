              ...
              <div class="max-w-7xl mx-auto">
                  <div class="flex flex-col md:flex-row w-full justify-center">
                                  ...
                                  <tr v-for="(banner, index) in banners" :key="banner.id">
                                      ...
                                      <td>
                                        <div class="flex items-center gap-1">
                                          <!-- update btn -->
                                          <button @click="openChangeStateModal(banner)" class="p-2  rounded-full  group transition-all duration-500  flex item-center">
                                          ...
                                          <button @click="deleteBanner(banner.id)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
                      ...
                      <BannerModal
                        ...
                        :bannerState="selectedBannerState"
                        @close="isModalVisible = false"
                        @update="updateBannerState"
                      />
...
const changeState = async () => {
  if (selectedBanner.value) {
    try {
      await Inertia.put(route('banners.updateState', selectedBanner.value.id), {
