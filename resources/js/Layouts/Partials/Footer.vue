    ...
    <footer class="bg-white-500">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center">
                        <img src="/images/ausllogo2.png" class="h-9 me-3" alt="AUSL Logo" />
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-purple-900 uppercase">Quick Links</h2>
                    <ul class="text-slate-700">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">News Archives</a>
                        </li>
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-purple-900 uppercase">Follow us</h2>
                    <ul class="text-slate-700">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-purple-900 uppercase">Legal</h2>
                    <ul class="text-slate-700">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">AULF</a>. All Rights Reserved.
            </span>
