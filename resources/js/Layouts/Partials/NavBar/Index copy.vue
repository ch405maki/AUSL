<template>
    <div>
      <!-- <div class="bg-official-purple-800 text-gray-700 hidden lg:block z-50 transition-all duration-300 fixed top-0 left-0 right-0">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative flex items-center justify-between">
        

        <div class="bg-noise-pattern absolute inset-0 opacity-10 z-0 pointer-events-none"></div>

        <div class="relative z-10 flex items-center space-x-2 ml-2">
          <img src="/images/alflogo.png" class="w-4" alt="Lawphil Logo">
          <span class="text-white text-xs font-semibold">ALF</span>
          <img src="/images/lawphilLogo.png" class="w-4" alt="Lawphil Logo">
          <span class="text-white text-xs font-semibold">Lawphil</span>
          <img src="/images/alflogo.png" class="w-4" alt="Lawphil Logo">
          <span class="text-white text-xs font-semibold">IChief</span>
        </div>  

        <div class="relative z-10 flex items-center space-x-4 mt-[2px]">
          <a href="" class="garamond text-white hover:underline">Faculty</a>
          <a href="" class="garamond text-white hover:underline">Student</a>
          <a href="" class="garamond text-white hover:underline">Applicant</a>
        </div>  
      ...
      <nav ref="firstNav" class="bg-official-purple-800 hidden lg:block z-50 border-b-[1px] transition-all duration-300 fixed top-0 left-0 right-0">
        <!-- Primary Navigation Menu -->
        <!-- <div class="absolute inset-x-0 top-0 h-[1px] bg-purple-400 z-0"></div> -->
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-[4px]">
          <!-- topBar -->
      ...
      <nav ref="navButtons" class="hidden lg:block bg-official-purple-800 left-0 right-0 z-40 transition-all duration-300 fixed top-[64px] second-nav">
        <!-- Primary Navigation Menu -->
  ...
  import HeadBar from './Partials/HeadBar.vue';
  ...
  .bg-noise-pattern {
  background-image: url('https://www.transparenttextures.com/patterns/noise.png'); /* This URL is a sample noise texture */
