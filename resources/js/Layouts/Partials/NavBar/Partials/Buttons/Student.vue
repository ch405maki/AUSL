<template>
    <div class="group inline-block relative">
        ...
        <span class="pr-1 font-normal flex-1 garamond hover:text-gray-300 uppercase">Student Resources</span>
        <span>
        ...
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
            <a href="https://aims.arellanolaw.edu/aims/students/"  target="_blank" rel="noopener noreferrer" class="block w-full text-left text-gray-600 hover:text-slate-900 font-normal">AIMS Portal</a>
        </li>
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
        ...
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
            <a :href="(route('student.closed-subject'))" class="block w-full text-left text-gray-600 hover:text-slate-900 font-normal cursor-pointer">Closed Subjects</a>
        </li>
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
