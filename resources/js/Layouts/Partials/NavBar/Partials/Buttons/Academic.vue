<template>
    <div class="group inline-block relative">
        ...
        <span class="pr-1 font-normal flex-1 garamond tracking-wide uppercase">Academics</span>
        <span>
        ...
        <li class="rounded-md relative px-2 py-2 transition duration-150 ease-in-out">
            ...
            <span class="pr-1 flex-1 block w-full text-left text-gray-600 hover:text-slate-900 font-normal">Juris Doctor</span>
            <span class="mr-auto">
        ...
        <li class="rounded-md relative px-2 py-2 transition duration-150 ease-in-out">
            <button class="w-full text-left flex items-center outline-none focus:outline-none">
            <span class="pr-1 flex-1 block w-full text-left text-gray-600 hover:text-slate-900 font-normal">Refresher</span>
            <span class="mr-auto">
                <svg class="fill-current h-4 w-4 transition duration-150 ease-in-out"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
            ...
            <ul class="bg-white border rounded-md shadow-lg absolute top-0 right-0 transition duration-300 ease-in-out origin-top-left min-w-32 mt-2">
            <li class="px-2 py-2 transition duration-150 ease-in-out">
                <a @click="$inertia.visit(route('emptyState'))" class="block w-full text-left text-gray-600 hover:text-slate-900 font-normal cursor-pointer">Curiculum</a>
            </li>
            </ul>
        </li>
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
            <a @click="$inertia.visit(route('emptyState'))" class="block w-full text-left text-gray-600 hover:text-slate-900 font-normal cursor-pointer">Bar Review</a>
        </li>
        <li class="rounded-md px-2 py-2 transition duration-150 ease-in-out">
            <a href="https://clear.arellanolaw.org/" class="block w-full text-left text-gray-600 hover:text-slate-900 font-normal cursor-pointer">MCLE</a>
        </li>
        </ul>
    </div>
</template>
